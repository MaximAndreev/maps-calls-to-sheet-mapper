...
public class TwoGisTableMapper extends AbstractSingleTableMapper implements TableMapper<CallStat> {

    public TwoGisTableMapper(int absoluteRowIndexOfFirstRowWithData) {
    ...
    protected Map<String, String> summaryRow(Integer countOfStatRows) {
        ...
        summaryRow.put("CPA общий", String.format("=%2$s%1$s/%3$s%1$s", firstNonHeadersRow, "Q", "D"));
        summaryRow.put("CPA ОП", String.format("=%2$s%1$s/(%3$s%1$s + %4$s%1$s)", firstNonHeadersRow, "Q", "E", "F"));
        summaryRow.put("CPA сервис", String.format("=%2$s%1$s/(%3$s%1$s + %4$s%1$s + %5$s%1$s)", firstNonHeadersRow, "Q", "G", "H", "J"));
        return summaryRow;
    }
    ...
    protected Map<String, String> statsRow(int currentRow, CallStat stat) {
        ...
        row.put("Всего звонков", String.format("" +
                "=(%2$s%1$s + %3$s%1$s + " +
                "%4$s%1$s + %5$s%1$s + %6$s%1$s)", currentRow, "E", "F", "G", "H", "J"));
        ...
        row.put("CPA общий", String.format("=%2$s%1$s/%3$s%1$s", currentRow, "Q", "D"));
        row.put("CPA ОП", String.format("=%2$s%1$s/(%3$s%1$s + %4$s%1$s)", currentRow, "Q", "E", "F"));
        row.put("CPA сервис", String.format("=%2$s%1$s/(%3$s%1$s + %4$s%1$s + %5$s%1$s)", currentRow, "Q", "G", "H", "J"));
        return row;
    }
